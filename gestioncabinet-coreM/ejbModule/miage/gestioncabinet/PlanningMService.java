...
public class PlanningMService implements PlanningRemoteService {
    ...
    public void init() throws ParseException {
        ...
        Patient p2 = new PatientM();
        p2.setPrenom("Johny");
        p2.setNom("WALKER");

        Patient p3 = new PatientM();
        p3.setPrenom("Jack");
        p3.setNom("TADAM");
