...
public class ConsultationTestClient {
	...
	public ConsultationTestClient() {
		...
		try{
			...
			service="ejb:gestioncabinet-tp2/GestionCabinet-coreM//PlanningService!miage.gestioncabinet.api.PlanningRemoteService?stateful";
			this.planningService = (PlanningRemoteService) locator.getRemoteInterface(service);
			service="ejb:gestioncabinet-tp2/GestionCabinet-coreM//ConsultationService!miage.gestioncabinet.api.ConsultationRemoteService?stateful";
